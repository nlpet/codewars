u"""
Reverse or totate problem.

The input is a string str of digits. Cut the string into chunks
(a chunk here is a substr of the initial string) of size sz
...
one position. Put together these modified chunks and return the result as a string.
